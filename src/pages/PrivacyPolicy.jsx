...
import { ArrowLeft, Shield, Globe, Mail, Lock } from "lucide-react";
        ...
        <div className="mx-auto max-w-6xl px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              <Shield className="w-4 h-4" style={{ color: colors.accent1 }} />
              <span className="text-sm font-medium" style={{ color: colors.text }}>
                {lang === "tr" ? "Site Gizlilik Politikası" : "Website Privacy Policy"}
              </span>
            </div>
            <button 
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-3 mb-6">
            <div className="p-3 rounded-2xl" style={{ background: `linear-gradient(135deg, ${colors.accent1}20, ${colors.accent2}20)` }}>
              <Shield className="w-8 h-8" style={{ color: colors.accent1 }} />
            </div>
          ...
          <p className="text-lg max-w-2xl mx-auto" style={{ color: colors.mute }}>
            {lang === "tr" 
              ? "Azakli Studio web sitesini ziyaret ettiğiniz için teşekkür ederiz. Bu sayfa, web sitemizi kullanırken toplanan, kullanılan ve korunan bilgilerinizi açıklar."
              : "Thank you for visiting the Azakli Studio website. This page describes the information we collect, use, and protect when you use our website."
            }
          </p>
        </div>
              ...
              <>
                <div className="mb-8 p-6 rounded-xl border" style={{ 
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <Globe className="w-5 h-5" style={{ color: colors.accent1 }} />
                    <h3 className="text-lg font-semibold" style={{ color: colors.text }}>
                      {lang === "tr" ? "Web Sitesi Bilgileri" : "Website Information"}
                    </h3>
                  </div>
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm"><strong>Şirket:</strong> Azakli Studio</span>
                    </div>
                ...
                <p className="mb-4">
                  Azakli Studio web sitesini ziyaret ettiğiniz için teşekkür ederiz. Bu Gizlilik Politikası, web sitemizi kullanırken toplanan, kullanılan ve korunan bilgilerinizi açıklar.
                </p>
                <p className="mb-6">
                ...
                <p className="mb-2"><strong>Bülten Aboneliği:</strong></p>
                <ul className="mb-6 space-y-1 list-disc list-inside">
                  <li>E-posta adresi</li>
                ...
                <h3 className="text-lg font-semibold mb-3" style={{ color: colors.text }}>3.1 Google Analytics</h3>
                <p className="mb-2"><strong>Web Sitesi Analitikleri:</strong></p>
                <ul className="mb-4 space-y-1 list-disc list-inside">
                  <li>Sayfa görüntüleme istatistikleri</li>
                  <li>Kullanıcı davranış analizi</li>
                  <li>Traffic kaynak analizi</li>
                  <li>Dönüşüm takibi</li>
                </ul>
                
                <h3 className="text-lg font-semibold mb-3" style={{ color: colors.text }}>3.2 Hosting Hizmetleri</h3>
                <p className="mb-2"><strong>Web Hosting:</strong></p>
                <ul className="mb-4 space-y-1 list-disc list-inside">
                  <li>Sunucu logları</li>
                  <li>Teknik performans verileri</li>
                  <li>Güvenlik logları</li>
                </ul>
                
                <h3 className="text-lg font-semibold mb-3" style={{ color: colors.text }}>3.3 E-posta Hizmetleri</h3>
                <p className="mb-2"><strong>İletişim Yönetimi:</strong></p>
                <ul className="mb-4 space-y-1 list-disc list-inside">
                  <li>E-posta gönderimi</li>
                  <li>Bülten yönetimi</li>
                  <li>İletişim formu işleme</li>
                </ul>
                
                <h3 className="text-lg font-semibold mb-3" style={{ color: colors.text }}>3.4 Çerez Yönetimi</h3>
                <p className="mb-2"><strong>Çerez Türleri:</strong></p>
                <ul className="mb-6 space-y-1 list-disc list-inside">
                  <li>Gerekli çerezler (site işlevselliği için)</li>
                ...
                <div className="mb-6 p-4 rounded-xl" style={{ background: "#fff3cd", border: "1px solid #ffc107" }}>
                  <p className="mb-2"><strong>Bu veriler; Web sitesi işlevselliği, Analiz, İletişim ve Kullanıcı deneyimi amaçlarıyla kullanılır; satılmaz ve isteğe bağlı kişiselleştirme sunulur.</strong></p>
                ...
                <h3 className="text-lg font-semibold mb-3" style={{ color: colors.text }}>4.1 Web Sitesi İşlevselliği</h3>
                <ul className="mb-4 space-y-1 list-disc list-inside">
                  <li>Web sitesi performansını sağlama</li>
                  <li>Kullanıcı deneyimini iyileştirme</li>
                  <li>Teknik sorunları çözme</li>
                </ul>

                <h3 className="text-lg font-semibold mb-3" style={{ color: colors.text }}>4.2 İletişim Hizmetleri</h3>
                <ul className="mb-4 space-y-1 list-disc list-inside">
                  <li>İletişim formlarını işleme</li>
                  <li>E-posta yanıtları gönderme</li>
                  <li>Bülten gönderimi</li>
                </ul>

                <h3 className="text-lg font-semibold mb-3" style={{ color: colors.text }}>4.3 Analiz ve Geliştirme</h3>
                <ul className="mb-4 space-y-1 list-disc list-inside">
                  <li>Web sitesi performansını izleme</li>
                  <li>Kullanıcı davranışlarını analiz etme</li>
                  <li>İçerik ve tasarım iyileştirmeleri</li>
                </ul>

                <h3 className="text-lg font-semibold mb-3" style={{ color: colors.text }}>4.4 Güvenlik</h3>
                <ul className="mb-6 space-y-1 list-disc list-inside">
                  <li>Web sitesi güvenliğini sağlama</li>
                  <li>Spam ve kötüye kullanımı önleme</li>
                  <li>Güvenlik tehditlerini tespit etme</li>
                </ul>
              ...
              <>
                <div className="mb-8 p-6 rounded-xl border" style={{ 
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full" style={{ background: colors.accent2 }} />
                      <span className="text-sm"><strong>Company:</strong> Azakli Studio</span>
                    </div>
                    <div className="flex items-center gap-2 md:col-span-2">
                      <Mail className="w-4 h-4" style={{ color: colors.accent1 }} />
                ...
                <p className="mb-4">
                  Thank you for visiting the Azakli Studio website. This Privacy Policy describes the information we collect, use, and protect when you use our website.
                </p>
                <p className="mb-6">
                ...
                <p className="mb-2"><strong>Website Analytics:</strong></p>
                <ul className="mb-4 space-y-1 list-disc list-inside">
                ...
                <p className="mb-2"><strong>Contact Forms:</strong></p>
                <ul className="mb-4 space-y-1 list-disc list-inside">
                ...
                <p className="mb-2"><strong>Newsletter Subscription:</strong></p>
                <ul className="mb-6 space-y-1 list-disc list-inside">
                  <li>Email address</li>
                ...
                <h3 className="text-lg font-semibold mb-3" style={{ color: colors.text }}>3.2 Hosting Services</h3>
                <p className="mb-2"><strong>Web Hosting:</strong></p>
                <ul className="mb-4 space-y-1 list-disc list-inside">
                  <li>Server logs</li>
                ...
                <h3 className="text-lg font-semibold mb-3" style={{ color: colors.text }}>3.3 Email Services</h3>
                <p className="mb-2"><strong>Communication Management:</strong></p>
                <ul className="mb-4 space-y-1 list-disc list-inside">
                  <li>Email sending</li>
                ...
                <h3 className="text-lg font-semibold mb-3" style={{ color: colors.text }}>3.4 Cookie Management</h3>
                ...
                <div className="mb-6 p-4 rounded-xl" style={{ background: "#fff3cd", border: "1px solid #ffc107" }}>
                  <p className="mb-2"><strong>This data is used for Website functionality, Analytics, Communication, and User experience purposes; it is not sold and optional personalization is offered.</strong></p>
                ...
                <h3 className="text-lg font-semibold mb-3" style={{ color: colors.text }}>4.1 Website Functionality</h3>
                <ul className="mb-4 space-y-1 list-disc list-inside">
                  <li>Ensuring website performance</li>
                  <li>Improving user experience</li>
                  <li>Resolving technical issues</li>
                </ul>

                <h3 className="text-lg font-semibold mb-3" style={{ color: colors.text }}>4.2 Communication Services</h3>
                <ul className="mb-4 space-y-1 list-disc list-inside">
                  <li>Processing contact forms</li>
                  <li>Sending email responses</li>
                ...
                <ul className="mb-4 space-y-1 list-disc list-inside">
                  ...
                  <li>Content and design improvements</li>
                </ul>

                <h3 className="text-lg font-semibold mb-3" style={{ color: colors.text }}>4.4 Security</h3>
                <ul className="mb-6 space-y-1 list-disc list-inside">
